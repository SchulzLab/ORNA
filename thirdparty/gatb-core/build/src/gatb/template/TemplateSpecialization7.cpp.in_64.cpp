...
template class GraphTemplate<Node_t<Kmer<64>::Type>,Edge_t<Node_t<Kmer<64>::Type > >, GraphDataVariantT>; 

template class Simplifications <Node_t<Kmer<64>::Type>,Edge_t<Node_t<Kmer<64>::Type > >, GraphDataVariantT>; 

// special instantiation (or specialization, i never know what's the difference)
// actually not sure if it's ever used
template <> template <> const Kmer<64>::Type& Node_t<Kmer<64>::Type>::getKmer() const
{
    return kmer;
}
